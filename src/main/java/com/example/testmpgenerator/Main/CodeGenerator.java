...
public class CodeGenerator {
    //项目的真实路径
    private static final String PROJECT_RELATIVE_PATH="D:\\IdeaProjects\\testMPGenerator";
...
//        mpg.setTemplateEngine(new FreemarkerTemplateEngine());    // 选择 freemarker 模板引擎，默认使用 Veloctiy
//        mpg.setTemplateEngine(new BeetlTemplateEngine());   // 选择 beetl 模板引擎，跟 freemaker 没什么区别
        ...
        //pc.setEntity() //如果不给各个模块设置具体的包路径，则默认是当前parent目录的entity包下
...
//        strategy.setTablePrefix("tb_");    //去掉数据库表名前缀
        strategy.setEntityLombokModel(true);    // 设置使用lombok
        strategy.setSkipView(false);    // 是否跳过视图的生成
